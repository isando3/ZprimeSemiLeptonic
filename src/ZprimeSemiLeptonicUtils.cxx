...
TopTagID_SoftDrop::TopTagID_SoftDrop(const std::string& wp_key){
  ...
  if     (wp_key == "mr001_wp1"){ mass_min_ = 105.; mass_max_ = 220.; tau32_max_ = .50; sjbtag_min_ = -1.; }
  ...
  else if(wp_key == "mr003_wp1"){ mass_min_ = 105.; mass_max_ = 220.; tau32_max_ = .57; sjbtag_min_ = -1.; }
  ...
  else if(wp_key == "mr010_wp1"){ mass_min_ = 110.; mass_max_ = 210.; tau32_max_ = .67; sjbtag_min_ = -1.; }
  else if(wp_key == "mr010_wp2"){ mass_min_ = 110.; mass_max_ = 210.; tau32_max_ = .69; sjbtag_min_ = .66; }
  else if(wp_key == "mr030_wp1"){ mass_min_ = 105.; mass_max_ = 220.; tau32_max_ = .81; sjbtag_min_ = -1.; }
