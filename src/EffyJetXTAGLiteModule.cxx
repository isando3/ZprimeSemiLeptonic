...
EffyJetXTAGLiteModule::EffyJetXTAGLiteModule(uhh2::Context& ctx){
  ...
  for(const auto& sel : htags_2){
    ...
    book_HFolder(sel               , new TTbarLJHistsSkimming      (ctx, sel               , ttag_ID_     , ttag_minDR_jet_));
  ...
  // elec-ID
  //const stelecID_SFac    = ctx.get("elecID_SF_file");
